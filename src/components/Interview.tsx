        ...
        <section className="grid gap-6 xl:grid-cols-[minmax(0,1.25fr)_minmax(340px,0.75fr)]">
          <div className="rounded-[30px] border border-white/10 bg-zinc-950/85 p-6 shadow-2xl shadow-black/25">
            ...
            <div className="mt-4 max-w-3xl space-y-3 text-base leading-8 text-zinc-300">
              <p>
                This section is for explanation-heavy interview reasoning rather than syntax drills.
              </p>
              <p>
                The emphasis is on runtime behavior, concurrency, architecture, distributed-system tradeoffs, and how to justify a design choice under pressure.
              </p>
            </div>
          </div>
          <div className="rounded-[30px] border border-white/10 bg-[#0d1117] p-5 shadow-2xl shadow-black/20">
            ...
            <div className="space-y-3 text-sm leading-7 text-zinc-300">
              <p>Junior questions check core runtime and language reasoning.</p>
              <p>Mid questions focus on tradeoffs, correctness, and production debugging.</p>
              <p>Senior questions shift toward architecture, backpressure, retries, profiling discipline, and service-boundary decisions.</p>
            </div>
          </div>
        </section>
