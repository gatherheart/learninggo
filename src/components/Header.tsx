      ...
      <div className="flex flex-col gap-4 px-4 py-4 lg:flex-row lg:items-center lg:justify-between lg:px-6">
        <div className="flex items-center gap-4">
          <Link to="/" className="flex items-center gap-3">
            <span className="grid h-11 w-11 place-items-center rounded-2xl border border-orange-400/50 bg-orange-500/15 text-lg font-bold text-orange-200 shadow-lg shadow-orange-950/40">G</span>
            <div>
              <div className="text-[11px] uppercase tracking-[0.16em] text-zinc-500">Go practice</div>
